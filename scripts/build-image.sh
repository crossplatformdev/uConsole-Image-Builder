...
echo "  SUITE=<suite> scripts/setup-suite.sh $OUTDIR"
echo "  Examples:"
echo "    - For trixie:   SUITE=trixie scripts/setup-suite.sh $OUTDIR"
echo "    - For bookworm: SUITE=bookworm scripts/setup-suite.sh $OUTDIR"
echo "    - For jammy:    SUITE=jammy scripts/setup-suite.sh $OUTDIR"
echo "    - For popos:    SUITE=popos scripts/setup-suite.sh $OUTDIR"
echo ""
echo "For custom kernel builds, use Docker: ./scripts/build_clockworkpi_kernel.sh"
