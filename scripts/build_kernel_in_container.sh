...
deb [arch=amd64] http://archive.ubuntu.com/ubuntu $(lsb_release -cs) main universe 
deb [arch=arm64] http://ports.ubuntu.com/ubuntu-ports $(lsb_release -cs) main universe
EOF
