...
env:
  ...
  UBUNTU_TASKS: 'ubuntu-standard ubuntu-server task-laptop network-manager netplan.io wpasupplicant net-tools openssh-client openssh-server rfkill fdisk powertop cpufreq*'
